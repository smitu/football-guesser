...
const MATCHES = [
  { id: 1, competition: "Liga Mistrzów - Finał", season: "1998/99", home: "Manchester United", away: "Bayern Monachium", score: "2:1", goals: [{ minute: 6, scorer: "Basler", team: "away" }, { minute: 91, scorer: "Sheringham", team: "home" }, { minute: 93, scorer: "Solskjær", team: "home" }], difficulty: "easy" },
  { id: 2, competition: "Liga Mistrzów - Finał", season: "2004/05", home: "AC Milan", away: "Liverpool", score: "3:3 (k. 2:3)", goals: [{ minute: 1, scorer: "Maldini", team: "home" }, { minute: 39, scorer: "Crespo", team: "home" }, { minute: 44, scorer: "Crespo", team: "home" }, { minute: 54, scorer: "Gerrard", team: "away" }, { minute: 56, scorer: "Šmicer", team: "away" }, { minute: 60, scorer: "Alonso", team: "away" }], difficulty: "easy" },
  { id: 3, competition: "MŚ - Finał", season: "2014", home: "Niemcy", away: "Argentyna", score: "1:0 (d.)", goals: [{ minute: 113, scorer: "Götze", team: "home" }], difficulty: "medium" },
  { id: 4, competition: "Liga Mistrzów - Półfinał", season: "2018/19", home: "Liverpool", away: "FC Barcelona", score: "4:0", goals: [{ minute: 7, scorer: "Origi", team: "home" }, { minute: 54, scorer: "Wijnaldum", team: "home" }, { minute: 56, scorer: "Wijnaldum", team: "home" }, { minute: 79, scorer: "Origi", team: "home" }], difficulty: "medium" },
  { id: 5, competition: "MŚ - Finał", season: "2022", home: "Argentyna", away: "Francja", score: "3:3 (k. 4:2)", goals: [{ minute: 23, scorer: "Messi", team: "home" }, { minute: 36, scorer: "Di María", team: "home" }, { minute: 80, scorer: "Mbappé", team: "away" }, { minute: 81, scorer: "Mbappé", team: "away" }, { minute: 108, scorer: "Messi", team: "home" }, { minute: 118, scorer: "Mbappé", team: "away" }], difficulty: "easy" },
  { id: 6, competition: "Premier League", season: "2011/12", home: "Manchester City", away: "QPR", score: "3:2", goals: [{ minute: 39, scorer: "Zabaleta", team: "home" }, { minute: 48, scorer: "Cissé", team: "away" }, { minute: 66, scorer: "Mackie", team: "away" }, { minute: 92, scorer: "Džeko", team: "home" }, { minute: 94, scorer: "Agüero", team: "home" }], difficulty: "medium" },
  { id: 7, competition: "Liga Mistrzów - Finał", season: "2016/17", home: "Juventus", away: "Real Madryt", score: "1:4", goals: [{ minute: 20, scorer: "Ronaldo", team: "away" }, { minute: 27, scorer: "Mandžukić", team: "home" }, { minute: 61, scorer: "Casemiro", team: "away" }, { minute: 64, scorer: "Ronaldo", team: "away" }, { minute: 90, scorer: "Asensio", team: "away" }], difficulty: "medium" },
  { id: 8, competition: "MŚ - Ćwierćfinał", season: "1986", home: "Argentyna", away: "Anglia", score: "2:1", goals: [{ minute: 51, scorer: "Maradona", team: "home" }, { minute: 55, scorer: "Maradona", team: "home" }, { minute: 81, scorer: "Lineker", team: "away" }], difficulty: "easy" },
  { id: 9, competition: "Liga Mistrzów - 1/8 Finału", season: "2016/17", home: "FC Barcelona", away: "PSG", score: "6:1", goals: [{ minute: 3, scorer: "Suárez", team: "home" }, { minute: 40, scorer: "Kurzawa (s.)", team: "home" }, { minute: 50, scorer: "Messi", team: "home" }, { minute: 62, scorer: "Cavani", team: "away" }, { minute: 88, scorer: "Neymar", team: "home" }, { minute: 91, scorer: "Neymar", team: "home" }, { minute: 95, scorer: "S. Roberto", team: "home" }], difficulty: "hard" },
  { id: 10, competition: "MŚ - Półfinał", season: "2014", home: "Brazylia", away: "Niemcy", score: "1:7", goals: [{ minute: 11, scorer: "Müller", team: "away" }, { minute: 23, scorer: "Klose", team: "away" }, { minute: 24, scorer: "Kroos", team: "away" }, { minute: 26, scorer: "Kroos", team: "away" }, { minute: 29, scorer: "Khedira", team: "away" }, { minute: 69, scorer: "Schürrle", team: "away" }, { minute: 79, scorer: "Schürrle", team: "away" }, { minute: 90, scorer: "Oscar", team: "home" }], difficulty: "medium" },
  { id: 11, competition: "Liga Mistrzów - Finał", season: "2010/11", home: "FC Barcelona", away: "Manchester United", score: "3:1", goals: [{ minute: 27, scorer: "Pedro", team: "home" }, { minute: 34, scorer: "Rooney", team: "away" }, { minute: 54, scorer: "Messi", team: "home" }, { minute: 69, scorer: "Villa", team: "home" }], difficulty: "medium" },
  { id: 12, competition: "Premier League", season: "2001/02", home: "Liverpool", away: "Arsenal", score: "1:2", goals: [{ minute: 26, scorer: "Ljungberg", team: "away" }, { minute: 73, scorer: "Hyypiä", team: "home" }, { minute: 83, scorer: "Henry", team: "away" }], difficulty: "hard" },
];
...
export default function FootballGeoGuesser() {
  ...
  const startGame = () => {
    const shuffled = shuffleArray(MATCHES).slice(0, 5);
    setMatches(shuffled);
  ...
  const handleSubmitGuess = useCallback((timeOut = false) => {
    clearInterval(timerRef.current);
    ...
    return (
      <div style={S.app}>
        <div style={{ ...S.card, ...S.center, marginTop: 40 }}>
          ...
          <p style={{ ...S.sub, marginTop: 16, marginBottom: 32 }}>Typuj minuty bramek w legendarnych meczach.<br />Im bliżej prawdy, tym więcej punktów.</p>
        ...
        <p style={{ color: "#3a5a44", fontSize: 11, marginTop: 24, letterSpacing: 1 }}>PoC v0.1 · 5 losowych meczy · 2026</p>
      </div>
    );
  }
  ...
  if (screen === "howto") {
    const steps = [
      ...
      { icon: "⏱️", title: "Masz 45 sekund", desc: "Na każdą bramkę masz ograniczony czas." },
        ...
        <div style={{ ...S.card, ...S.center, marginTop: 40 }}>
          ...
          <div style={{ marginTop: 24 }}>
            <input
              ...
              style={{ width: "100%", padding: "12px 16px", background: "#0a1610", border: "1px solid #1a3a24", borderRadius: 8, color: "#e8e8e3", fontSize: 15, marginBottom: 12, boxSizing: "border-box", outline: "none" }}
            />
        ...
        <div style={{ ...S.card, position: "relative" }}>
          ...
          <div style={{ ...S.center, padding: "16px", background: "rgba(29,185,84,0.06)", borderRadius: 10, border: "1px solid rgba(29,185,84,0.15)", marginBottom: 20 }}>
            ...
            <div style={{ fontSize: 16, fontWeight: 700 }}>
              ...
              <span style={{ color: "#1db954" }}>{currentGoal.scorer}</span>
          ...
          {showResult && lastScore && (
            <div style={{ ...S.center, padding: "20px", background: `${getScoreColor(lastScore.score)}11`, borderRadius: 12, border: `1px solid ${getScoreColor(lastScore.score)}33`, marginBottom: 20, animation: "fadeIn 0.3s ease-out" }}>
              <div style={{ fontSize: 28, fontWeight: 800, color: getScoreColor(lastScore.score) }}>{getScoreLabel(lastScore.score)}</div>
              {lastScore.timeOut ? (
                <div style={{ fontSize: 14, color: "#8a9a8e", marginTop: 8 }}>Czas minął! Bramka padła w <b style={{ color: "#e8e8e3" }}>{lastScore.actual}'</b></div>
              ) : (
          ...
          {/* Action buttons */}
          {!showResult ? (
            <button style={S.greenBtn} onClick={() => handleSubmitGuess(false)}>
              ZATWIERDŹ · {guessedMinute}'
            </button>
          ) : (
